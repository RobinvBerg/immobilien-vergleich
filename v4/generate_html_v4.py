...
# Project root = 3 levels up from scripts/generate/
PROJECT_ROOT = Path(__file__).resolve().parent.parent
XLSX   = PROJECT_ROOT / 'data'   / 'mallorca-kandidaten-v4.xlsx'
OUT    = PROJECT_ROOT / 'v4/mallorca-ranking-v4.html'
BILDER = PROJECT_ROOT / 'bilder'
BASE   = str(PROJECT_ROOT)  # kept for compatibility

wb = openpyxl.load_workbook(XLSX, data_only=True)
ws = wb['Mallorca Kandidaten']
ws_e = wb["Einstellungen (aktuell)"]
