...
wb = openpyxl.load_workbook('mallorca-objekte.xlsx')
ws = wb['Objekte']
...
with open('mallorca-ranking-v5.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
with open('mallorca-ranking-v5.html', 'w', encoding='utf-8') as f:
    f.write(html)
