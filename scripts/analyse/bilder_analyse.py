...
BASE         = PROJECT_ROOT
BILDER_DIR   = PROJECT_ROOT / "bilder"
BILDER_DIR.mkdir(exist_ok=True)
LOG         = PROJECT_ROOT / "debug" / "bilder_analyse_log.txt"
CHECKPOINT  = PROJECT_ROOT / "debug" / "bilder_analyse_checkpoint.json"
EXCEL       = PROJECT_ROOT / "data"  / "mallorca-kandidaten-v2.xlsx"
BILDER_JSON = PROJECT_ROOT / "debug" / "mallorca-bilder.json"
