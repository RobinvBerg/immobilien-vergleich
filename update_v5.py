...
# ── Load reno data ──
with open('/Users/robin/.openclaw/workspace/mallorca-projekt/reno_scores.json') as f:
    reno_data = json.load(f)

# ── TEIL 1: Excel update ──
import openpyxl
wb = openpyxl.load_workbook('/Users/robin/.openclaw/workspace/mallorca-projekt/mallorca-objekte.xlsx')
ws = wb.active
...
wb.save('/Users/robin/.openclaw/workspace/mallorca-projekt/mallorca-objekte.xlsx')
print("✅ Excel updated")

# ── TEIL 2: HTML v5 ──
src = '/Users/robin/.openclaw/workspace/mallorca-projekt/mallorca-ranking-v4.html'
dst = '/Users/robin/.openclaw/workspace/mallorca-projekt/mallorca-ranking-v5.html'
