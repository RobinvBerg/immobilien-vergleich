...
wb_master = load_workbook('/Users/robin/.openclaw/workspace/mallorca-projekt/mallorca-objekte-v2.xlsx')
...
wb_raw = load_workbook('/Users/robin/.openclaw/workspace/mallorca-projekt/Mallorca_Markt_Gesamt.xlsx')
...
for obj in new_objects:
    ...
    if added % 100 == 0:
        wb_master.save('/Users/robin/.openclaw/workspace/mallorca-projekt/mallorca-objekte-v2.xlsx')
